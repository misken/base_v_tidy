...
So, I figured this was a good excuse to poke around in the [tidymodels](https://www.tidymodels.org/) world.
...
rabbit hole of the base R vs tidyverse debate for new R learners. As 
...
exchange ideas and different approaches to doing work with R. R is a rich and
deep language and debates like this get into some nooks and crannies
that many might never otherwise know about.
...
and [this one](https://www.reddit.com/r/rprogramming/comments/rd4ksl/i_am_concerned_about_the_tidyverse_and_its_impact/). One of the comments I found in this thread makes the following argument:
...
At the same time, students immediately start to learn their way around R Studio and R Markdown documents
...
Reading piped dplyr code is somewhat similar to reading SQL and is something
that new R learners can do with practice and by starting out with standard
intro SQLish dplyr statements.
